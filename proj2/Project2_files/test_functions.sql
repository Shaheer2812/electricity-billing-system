...
BEGIN
    ...
    ret_val := fun_compute_BillingDays('DISCO-RES-1123', 9, 2024);
    DBMS_OUTPUT.PUT_LINE('Billing Days: ' || ret_val);

    -- -- compute import peak units
    l_peakUnits := fun_compute_ImportPeakUnits('DISCO-RES-1123', 9, 2024);
    DBMS_OUTPUT.PUT_LINE('Import Peak Units: ' || l_peakUnits);

    -- -- compute import off-peak units
    l_offPeakUnits := fun_compute_ImportOffPeakUnits('DISCO-RES-1123', 9, 2024);
    DBMS_OUTPUT.PUT_LINE('Import Off-Peak Units: ' || l_offPeakUnits);

    -- -- compute export off-peak units
    ret_val := fun_compute_ExportOffPeakUnits('DISCO-RES-1123', 9, 2024);
    DBMS_OUTPUT.PUT_LINE('Export Off-Peak Units: ' || ret_val);

    -- -- compute peak amount
    l_peakAmount := fun_compute_PeakAmount('DISCO-RES-1123', 9, 2024, TO_DATE('10-OCT-2024', 'DD-MON-YYYY'));
    DBMS_OUTPUT.PUT_LINE('Amount for peak units: ' || l_peakAmount);

    -- -- compute off-peak amount
    l_offPeakAmount := fun_compute_OffPeakAmount('DISCO-RES-1123', 9, 2024, TO_DATE('10-OCT-2024', 'DD-MON-YYYY'));
    DBMS_OUTPUT.PUT_LINE('Off-Peak Amount: ' || l_offPeakAmount);

    -- -- compute tax amount
    ret_val := fun_compute_TaxAmount('DISCO-RES-1123', 9, 2024, TO_DATE('10-OCT-2024', 'DD-MON-YYYY'), l_peakAmount, l_offPeakAmount);
    DBMS_OUTPUT.PUT_LINE('Tax Amount: ' || ret_val);

    -- -- compute FixedFee
    ret_val := fun_compute_FixedFee('DISCO-RES-1123', 9, 2024, TO_DATE('10-OCT-2024', 'DD-MON-YYYY'));
    DBMS_OUTPUT.PUT_LINE('Fixed Fee: ' || ret_val);

    -- -- compute Arrears
    ret_val := fun_compute_Arrears('DISCO-RES-1123', 9, 2024, TO_DATE('10-OCT-2024', 'DD-MON-YYYY'));
    DBMS_OUTPUT.PUT_LINE('Arrears: ' || ret_val);

    -- -- compute SubsidyAmount
    ret_val := fun_compute_SubsidyAmount('DISCO-RES-1123', 9, 2024, TO_DATE('10-OCT-2024', 'DD-MON-YYYY'), l_peakUnits, l_offPeakUnits);
    ...
    ret_val := fun_batch_Billing(9, 2024, TO_DATE('10-OCT-2024', 'DD-MON-YYYY'));
